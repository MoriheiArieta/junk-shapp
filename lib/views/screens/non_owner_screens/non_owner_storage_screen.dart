...
class NonOwnerStorageScreen extends StatefulWidget {
  final dynamic junkShopData;

  const NonOwnerStorageScreen({super.key, this.junkShopData});
  @override
  State<NonOwnerStorageScreen> createState() => _NonOwnerStorageScreenState();
}

class _NonOwnerStorageScreenState extends State<NonOwnerStorageScreen> {
